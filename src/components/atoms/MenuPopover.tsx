...
const ArrowStyle = styled('span')(({ arrow, theme }: {
    ...
    const borderStyle = `solid 1px ${theme.palette.background.paper}`;
...
export default function MenuPopover({ children, arrow = 'top-right', disabledArrow = false, sx, ...other }: MenuPopoverProps) {
    ...
    return (
        <Popover
            ...
            {...other}
        >
            {!disabledArrow && <ArrowStyle arrow={arrow} theme={theme} />}
