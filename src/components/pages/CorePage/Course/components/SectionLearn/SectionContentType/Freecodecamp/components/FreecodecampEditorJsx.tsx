...
function FreecodecampEditorJsx({
    sx,
    question,
    idPassed,
    file
                        ...
                        addScript('/monaco/editor/editor.main.nls.js', 'monaco-main.nls', function () {
                            addScript('/monaco/editor/editor.main.js', 'monaco-main', function () {
                                addScript('/monaco/emmet-monaco.min.js', 'emmet-monaco', function () {
                                    ...
                                    window.monaco.editor.getModels().forEach((model: ANY) => model.dispose());
                                    ...
                                    if (window.monaco) {
                                        ...
                                        window.monaco.languages.typescript.typescriptDefaults.setCompilerOptions({
                                            jsx: window.monaco.languages.typescript.JsxEmit.Preserve,
                                            target: window.monaco.languages.typescript.ScriptTarget.ES2020,
                                            esModuleInterop: true
                                        })

                                        const model2 = window.monaco.editor.createModel(
                                            file.contents,
                                            'typescript',
                                            window.monaco.Uri.parse('index.tsx')
                                        )
                                        ...
                                        editor.current.setModel(model2);

                                        handleEditorDidMount(editor.current, window.monaco);
    ...
    return (
        <Box
            ...
            sx={{
                ...
                '--stringColor': '#55bb8a',
                '--languageKeywordColor': '#619ac3',
                '--globalVariableColor': '#ba2f7b',
                '--unusedOpacity': '0.4',
                '--normalTextColor': '#fffef8',
                '--grammarColor': '#57c3c2',
                '--jsxTagSymbolColor': '#619ac3',
                '--jsxTagColor': '#ba2f7b',
                '--jsxAttributeColor': '#ffa60f',
                '--jsxTextColor': '#a0a0a0',
                '& *': {
                    userSelect: 'text',
                },
                ...
                '& .mtk22': {
                    color: 'var(--globalVariableColor)',
                },

                '& .mtk8': {
                    color: 'var(--languageKeywordColor)',
                },
                ...
                '& .jsx-tag-angle-bracket': {
                    ...
                    color: 'var(--jsxTagSymbolColor)',
                },

                '& .jsx-tag-name': {
                    color: 'var(--jsxTagColor)',
                },

                '& .jsx-tag-attribute-key': {
                    color: 'var(--jsxAttributeColor)',
                },

                '& .jsx-text': {
                    color: 'var(--jsxTextColor)',
                },
...
export default FreecodecampEditorJsx