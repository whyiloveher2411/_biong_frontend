...
export default function SectionAbout({
    ...
    const progressBuyCourse: Array<[string, string, (() => JSX.Element | undefined)?]> = [
        [
            ...
            () => <Button variant="contained" component={LinkMui} href="https://www.facebook.com/groups/1653227468954919" target="_blank">Tham gia nhóm</Button>
        ],
        [
            'Bắt đầu học tập',
    ...
    return (
        ...
        >
            ...
            {
                !course?.course_detail?.hidden_process_join &&
                <Box
                    sx={{
                        position: 'relative',
                    }}
            ...
            >
                {
                    Boolean(course?.course_detail?.requirements?.length) &&
                    <Grid
                        item
                        md={6}
                        sx={(theme) => ({
                ...
                {
                    Boolean(course?.course_detail?.who?.length) &&
                    <Grid
                        item
                        md={6}
                        sx={(theme) => ({
