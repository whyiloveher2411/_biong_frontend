    ...
    return (<>
        ...
        >
            ...
            >
                ...
                <Typography sx={{ display: 'flex', gap: 1, alignItems: 'center', }}><Icon icon="Groups2Outlined" /> Cộng đồng <a target='_blank' href="https://www.facebook.com/groups/fullstacknodejsreactjs">Lập Trình Fullstack (Nodejs/Reactjs)</a></Typography>
