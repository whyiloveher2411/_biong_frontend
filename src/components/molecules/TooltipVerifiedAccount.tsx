        ...
        <TooltipWhite
            title={
                ...
                >
                    ...
                    <Typography sx={{ mt: '4px', mb: '4px', }} variant='h3' align='center'>{__('Tài khoản xác mình')}</Typography>
                    <Typography sx={{ fontSize: 14, lineHeight: '22px', }} align='center'>{__('Tài khoản này đã được xác minh các thông tin cá nhân là thật.')}</Typography>
                </Box>
            }
        >
