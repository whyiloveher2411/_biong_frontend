        ...
        <Tooltip
            title={
                ...
                >
                    ...
                    <Typography sx={{ color: 'primary.contrastText', letterSpacing: '0.5px', mt: '4px', mb: '4px', }} variant='h3' align='center'>{__('Thông tin tài khoản')}</Typography>
                    <Typography sx={{ color: 'primary.contrastText', fontSize: 14, letterSpacing: '0.5px', lineHeight: '22px', }} align='center'>{__('Tài khoản này đã được xác minh các thông tin cá nhân và quá trình làm việc.')}</Typography>
                </Box>
            }
        >
