...
export const strip = ((input, options) => {
    const opts = Object.assign(Object.assign({}, options), { block: true, line: true });
...
strip.block = (input, options) => {
    const opts = Object.assign(Object.assign({}, options), { block: true });
    return compile(parse(input, opts), opts);
};
/**
...
strip.line = (input, options) => {
    const opts = Object.assign(Object.assign({}, options), { line: true });
    return compile(parse(input, opts), opts);
};
/**
...
strip.first = (input, options) => {
    const opts = Object.assign(Object.assign({}, options), { block: true, line: true, first: true });
    return compile(parse(input, opts), opts);
};
/**
